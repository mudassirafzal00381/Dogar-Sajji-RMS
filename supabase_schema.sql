-- ══════════════════════════════════════════════════════════════════════════════
-- ⚡ DOGAR SAJJI RMS — FULL DATABASE RESET, RECREATION & INITIAL DATA
-- ══════════════════════════════════════════════════════════════════════════════
-- Instructions to reset your Supabase database:
-- 1. Open your Supabase Dashboard: https://supabase.com/dashboard
-- 2. Go to "SQL Editor" in the left sidebar
-- 3. Click "New Query", paste this entire script, and click "RUN"
-- 4. All tables will be cleanly recreated and seeded with Dogar Sajji Menu & Users!
-- ══════════════════════════════════════════════════════════════════════════════

-- ── 0. CLEAN RESET: DROP EXISTING TABLES ──
DROP TABLE IF EXISTS public.orders CASCADE;
DROP TABLE IF EXISTS public.unpaid_bills CASCADE;
DROP TABLE IF EXISTS public.sales_ledger CASCADE;
DROP TABLE IF EXISTS public.cancelled_orders CASCADE;
DROP TABLE IF EXISTS public.petty_cash CASCADE;
DROP TABLE IF EXISTS public.expense_ledger CASCADE;
...
-- ── 5. ACTIVE ORDERS (KITCHEN / RUNNING ORDERS) ──
...
-- ── 10. SALES LEDGER (COMPLETED TRANSACTIONS) ──
...
-- ══════════════════════════════════════════════════════════════════════════════
-- ENABLE ROW LEVEL SECURITY & OPEN POLICIES (FOR POS CLIENT ACCESS)
-- ══════════════════════════════════════════════════════════════════════════════
...
-- Create Open Full Access Policies
DO $$ 
DECLARE
  t text;
BEGIN
...
-- ══════════════════════════════════════════════════════════════════════════════
-- ENABLE REALTIME LIVE SUBSCRIPTIONS
-- ══════════════════════════════════════════════════════════════════════════════
DO $$
DECLARE
  tbl_name text;
